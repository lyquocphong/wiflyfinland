        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">              
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center col-lg-12 d-lg-block">
                    <img src="http://wiflyfinland.edu.vn/upload/hinhanh/logo-chinh-sua-lan-2-7873.png" alt="Wifly logo" style="height:180px">
                  </div>
                  ...
                  <form action="<?=base_url('auth/login')?>" method="post" class="user">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="username" name="username" placeholder="Username" value="<?php $this->input->post('username')?>" required>
                    </div>
                    <div class="form-group">
                    ...
                    <input type="submit" class="btn btn-primary btn-user btn-block" id="loginBtn" value="Login"/>                    
                  </form>
                  <hr>
                  <!-- <div class="text-center">
