            ...
            <div class="col-md-3">
                <form action="index.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="template" name="template" value="<?php echo isset($_POST['template']) ? $_POST['template'] : 'dashboard' ?>" class="form-control" placeholder="Template Name" />
                    </div>
                    <div class="form-group">
                        <label>Controller Class</label>
                        <input type="text" id="controller_class" name="controller_class" value="<?php echo isset($_POST['controller_class']) ? $_POST['controller_class'] : 'MY_Controller' ?>" class="form-control" placeholder="Controller Class Need to implement" />
                    </div>
