...
class " . $c . " extends $controller_class
{
...
$string .= "\n\n    public function index()
    {
        ...
        \$this->render('$c_url/$v_list', \$data, '$template');
    }";
...
$string .="\n\n    public function index()
    {
        \$this->render('$c_url/$v_list', [] , '$template');
    } 
...
$string .= "\n\t    );
            \$this->render('$c_url/$v_read', \$data, '$template');
        } else {
...
$string .= "\n\t);
        \$this->render('$c_url/$v_form', \$data, '$template');
    }
